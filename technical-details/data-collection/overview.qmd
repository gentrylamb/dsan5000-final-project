...
We utilized [Selenium](https://www.selenium.dev/documentation/webdriver/), an open-source framework for automating web browsers, to scrape data from bikewashington.org. The scraped information included trail names, descriptions, lengths, and ratings, which were initially stored in lists and later consolidated into a single Pandas DataFrame. 
