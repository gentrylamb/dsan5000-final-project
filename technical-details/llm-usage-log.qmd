...
* Once we decided on a topic, ChatGPT was used to help with refining our research questions and narrow in on topics for related work.
...
* Used ChatGPT to help with error that was faced when accessing the ChromeDriver for Selenium. It suggested that we add the 4 lines of code adjusting chrome options.
